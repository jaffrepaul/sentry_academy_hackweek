import { ResearchedContent, ResearchSource, ResearchSourceConfig } from '../types/aiGeneration'
...
class ContentResearchEngine {
  ...
  async researchSentryContent(
    ...
    for (let i = 0; i < enabledSources.length; i++) {
      ...
      try {
        ...
        updateGenerationProgress(requestId, {
          logs: [
            `Warning: Failed to research ${this.getSourceDisplayName(sourceConfig.source)}: ${error}`,
          ],
        })
      }
    }
  ...
  private async researchSentryMain(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockMainPages = [
      {
        ...
        content: this.generateMockDocContent(
          'Comprehensive overview of Sentry platform features',
          keywords
        ),
        section: 'Features',
      },
      {
        ...
        content: this.generateMockDocContent(
          'Sentry pricing tiers and feature comparison',
          keywords
        ),
        section: 'Pricing',
      },
  ...
  private async researchSentryDocs(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
  ...
  private async researchSentryProductDocs(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockProductPages = [
      ...
      },
      {
        ...
        content: this.generateMockDocContent(
          'Managing releases and tracking deployment health',
          keywords
        ),
      },
    ]
  ...
  private async researchSentryBlog(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockBlogPosts = [
      {
        ...
        content: this.generateMockBlogContent(
      ...
      },
      {
        ...
        content: this.generateMockBlogContent(
          'Advanced techniques for debugging production JavaScript applications',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockBlogContent(
          'How to monitor the health of your releases',
          keywords
        ),
      },
    ]
  ...
  private async researchCustomerStories(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockCustomerStories = [
      {
        ...
        content: this.generateMockCustomerContent(
          'Dropbox case study on error monitoring and performance optimization',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockCustomerContent(
          "Microsoft's approach to application monitoring at scale",
          keywords
        ),
      },
    ]
  ...
  private async researchComparisonContent(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockComparisonContent = {
      ...
      content: this.generateMockComparisonContent(
        'Comparison between Sentry and traditional logging approaches',
        keywords
      ),
    }
  ...
  private async researchYouTubeContent(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    ...
    const mockVideoContent = {
      ...
      content: this.generateMockVideoContent(
        'Video tutorial on implementing performance monitoring',
        keywords
      ),
    }
  ...
  private async researchAnswersContent(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockAnswersContent = [
      {
        ...
        content: this.generateMockAnswersContent(
          'Community-driven solutions for JavaScript error handling',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockAnswersContent(
          'Performance monitoring best practices from the community',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockAnswersContent(
          'Expert debugging techniques and troubleshooting guides',
          keywords
        ),
      },
    ]
  ...
  private async researchSupportContent(
    keywords: string[],
    _priority: number
  ): Promise<ResearchedContent[]> {
    const results: ResearchedContent[] = []
    ...
    const mockSupportContent = [
      {
        ...
        content: this.generateMockSupportContent(
          'Step-by-step guide to setting up Sentry',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockSupportContent(
          'Solutions for common Sentry setup and configuration issues',
          keywords
        ),
      },
      {
        ...
        content: this.generateMockSupportContent(
          'Comprehensive SDK configuration and best practices',
          keywords
        ),
      },
    ]
