    ...
    async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { action: 'getUserProgress', userId: session.user.id },
        })
  ...
  return await Sentry.withServerActionInstrumentation(
    ...
    async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { action: 'updateUserRole', userId: session.user.id, role },
          extra: { role, selectedFeatures },
        })
  ...
  return await Sentry.withServerActionInstrumentation(
    ...
    async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { action: 'updateUserProgress', userId: session.user.id },
          extra: { updates },
        })
  ...
  return await Sentry.withServerActionInstrumentation(
    ...
    async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { action: 'completeModule', userId: session.user.id, moduleId },
          extra: { moduleId },
        })
  ...
  return await Sentry.withServerActionInstrumentation(
    ...
    async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { action: 'resetProgress', userId: session.user.id },
        })
