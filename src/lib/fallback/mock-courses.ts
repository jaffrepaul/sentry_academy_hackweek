...
const mockCoursesData = [
  {
    ...
    content:
      'Complete course content for Sentry Fundamentals covering SDK installation, error tracking, and basic monitoring setup.',
    difficulty: 'Beginner',
    duration: '10 min',
    category: 'Foundation',
    level: 'Beginner',
  ...
  },
  {
    ...
    content:
      'In-depth coverage of Sentry logging features, structured logging patterns, and log analysis.',
  ...
  },
  {
    ...
    content:
      'Comprehensive guide to performance monitoring, Web Vitals tracking, and performance optimization strategies.',
    difficulty: 'Advanced',
    duration: '2.1 hrs',
  ...
  },
  {
    ...
    content:
      'Complete Node.js integration guide covering Express middleware, error tracking, and backend monitoring.',
    difficulty: 'Intermediate',
    duration: '1.8 hrs',
    category: 'Backend',
    level: 'Intermediate',
  ...
  },
  {
    ...
    content:
      'User feedback integration, error correlation, and feedback-driven development workflows.',
    difficulty: 'Intermediate',
    duration: '1.5 hrs',
    category: 'UX',
    level: 'Intermediate',
  ...
  },
  {
    ...
    content:
      'Advanced AI-powered debugging with Seer, MCP implementation, and ML observability patterns.',
    difficulty: 'Advanced',
    duration: '3.5 hrs',
    category: 'AI/ML',
    level: 'Advanced',
  ...
  },
  {
    ...
    content:
      'Dashboard design for non-technical stakeholders, metrics communication, and business impact visualization.',
    difficulty: 'Beginner',
    duration: '2.0 hrs',
    category: 'Management',
    level: 'Beginner',
  ...
  },
  {
    ...
    content:
      'Product management with Sentry data, metrics interpretation, and data-driven decision making.',
    difficulty: 'Beginner',
    duration: '1.5 hrs',
    category: 'Management',
    level: 'Beginner',
