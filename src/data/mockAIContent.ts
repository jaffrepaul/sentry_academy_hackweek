import { AIGeneratedCourse, ResearchedContent, ResearchSource } from '../types/aiGeneration'
...
export function generateMockAIContent() {
  ...
  const mockResearchedContent: ResearchedContent[] = [
    {
      ...
      content:
        'Profiling in Sentry allows you to collect and analyze performance data from your applications. This helps identify bottlenecks and optimize performance.',
      relevanceScore: 0.95,
    ...
    },
    {
      ...
      content:
        'Learn how to effectively use profiling data to improve application performance. Best practices include setting appropriate sample rates and focusing on hot paths.',
      relevanceScore: 0.88,
      extractedAt: new Date(),
      ...
      useCases: ['Production performance monitoring', 'Development optimization workflows'],
    },
  ]
  ...
  const mockAICourse: AIGeneratedCourse = {
    ...
    description:
      'Master application profiling techniques using Sentry to identify performance bottlenecks and optimize your code. Learn to set up profiling, analyze data, and implement performance improvements.',
    duration: '2.5 hrs',
    level: 'Advanced',
    rating: 4.7,
    students: 0,
    ...
    generatedModules: [
      {
        ...
        description:
          'Learn how to configure and enable profiling in your Sentry-monitored applications.',
        duration: '20 min',
        isCompleted: false,
        keyTakeaways: [
        ...
        scenario:
          'Your team needs to identify why the checkout process in your e-commerce application has become 40% slower over the past month.',
        codeExample:
      ...
      },
      {
        ...
        description:
          'Master the art of reading flame graphs and identifying performance bottlenecks from profiling data.',
        duration: '35 min',
        isCompleted: false,
        keyTakeaways: [
        ...
        scenario:
          'You have collected profiling data showing that 60% of CPU time is spent in an unknown function. Learn to trace this back to actionable optimization opportunities.',
        codeExample:
          '// Create custom profiling spans for detailed analysis\nconst transaction = Sentry.startTransaction({ name: "user-checkout" });\n\nconst span = transaction.startChild({\n  op: "function",\n  description: "process-payment"\n});\n\ntry {\n  const result = await processPayment(paymentData);\n  span.setStatus("ok");\n  return result;\n} catch (error) {\n  span.setStatus("internal_error");\n  throw error;\n} finally {\n  span.finish();\n  transaction.finish();\n}',
        contentConfig: {
          hasHandsOn: true,
          hasScenario: true,
          hasCodeExample: true,
        ...
        sourceReferences: [
          ...
          'https://blog.sentry.io/profiling-analysis/',
        ],
        confidence: 0.89,
      },
      {
        ...
        description:
          'Apply profiling insights to implement effective performance optimizations in your codebase.',
        duration: '30 min',
        isCompleted: false,
        keyTakeaways: [
        ...
        scenario:
          "Using profiling data, you've identified that JSON serialization is consuming 25% of your API response time. Learn systematic approaches to optimize this bottleneck.",
        codeExample:
          '// Before optimization - identified via profiling\nfunction serializeResponse(data) {\n  return JSON.stringify(data); // Hot path identified\n}\n\n// After optimization\nconst responseCache = new Map();\n\nfunction serializeResponse(data) {\n  const key = generateCacheKey(data);\n  if (responseCache.has(key)) {\n    return responseCache.get(key);\n  }\n  \n  const serialized = JSON.stringify(data);\n  responseCache.set(key, serialized);\n  return serialized;\n}',
        contentConfig: {
          hasHandsOn: true,
          hasScenario: true,
          hasCodeExample: true,
        ...
        sourceReferences: [
          'https://docs.sentry.io/product/profiling/',
          'https://blog.sentry.io/optimization-strategies/',
        ],
        confidence: 0.87,
      },
      {
        ...
        description:
          'Implement sustainable profiling strategies for production environments without impacting performance.',
        duration: '25 min',
        isCompleted: false,
        keyTakeaways: [
        ...
        scenario:
          'Your application serves 10,000 requests per second. Design a profiling strategy that provides actionable insights while maintaining sub-1ms overhead.',
        codeExample:
        ...
        sourceReferences: [
          'https://docs.sentry.io/product/profiling/',
          'https://blog.sentry.io/production-profiling/',
        ],
        confidence: 0.9,
      },
    ],
    rolePersonalizations: [
      {
        roleId: 'frontend',
        explanation:
          "Frontend profiling focuses on JavaScript execution, rendering performance, and user interaction bottlenecks. You'll learn to identify slow React components, optimize bundle sizes, and improve Core Web Vitals.",
        whyRelevant:
          'Frontend performance directly impacts user experience, conversion rates, and SEO rankings. Profiling helps you identify which JavaScript code is causing the biggest user experience issues.',
        nextStepNudge:
          'Ready to optimize your React components and improve page load times? Continue to see how profiling integrates with your frontend monitoring workflow.',
        difficulty: 'advanced',
      ...
      },
      {
        roleId: 'backend',
        explanation:
          'Backend profiling helps you identify database bottlenecks, slow API endpoints, and inefficient algorithms. Learn to optimize server response times and reduce infrastructure costs.',
        whyRelevant:
          'Backend performance affects every user request and directly impacts server costs, scalability, and user satisfaction. Profiling helps prioritize optimization efforts for maximum impact.',
        nextStepNudge:
          'Ready to optimize your API performance and reduce server costs? Learn how to integrate profiling into your backend monitoring strategy.',
        difficulty: 'advanced',
        roleSpecificExamples: [
      ...
      },
      {
        roleId: 'fullstack',
        explanation:
          "Full-stack profiling provides end-to-end performance insights from browser to database. You'll learn to correlate frontend and backend performance data for comprehensive optimization.",
        whyRelevant:
          'As a full-stack engineer, you need visibility into performance bottlenecks across the entire application stack to optimize user experience and system efficiency.',
        nextStepNudge:
          'Ready to optimize performance across your entire application stack? Learn how to correlate frontend and backend profiling data.',
        difficulty: 'advanced',
        roleSpecificExamples: [
