...
export const concepts: Concept[] = [
  ...
  },
  {
    ...
    imageAlt:
      'The anatomy of a trace showing trace spanning entire operation, browser connect, http.client spans, and nested resource operations with timing details',
    order: 11,
  },
  {
    ...
    imageUrl: '/anatomy-of-a-trace.webp',
    imageAlt:
      'Trace anatomy diagram showing transaction structure with nested spans including browser connect, http.client operations, and resource spans with timing information',
    order: 12,
  },
]
