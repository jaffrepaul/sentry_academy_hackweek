...
export const roles: RoleInfo[] = [
  {
    ...
    description:
      'Monitor client-side issues, analyze user experience, and incorporate user feedback for rapid debugging.',
    icon: '🎨',
    commonTasks: [
  ...
  },
  {
    ...
    description:
      'Build a seamless, end-to-end observability pipeline across frontend and backend systems.',
    icon: '🚀',
    commonTasks: [
  ...
  },
  {
    ...
    description:
      'Enable technical and non-technical stakeholders to analyze, interpret, and act on data from Sentry.',
    icon: '📊',
    commonTasks: [
...
export const learningPaths: LearningPath[] = [
    ...
    steps: [
      {
        ...
        title: 'Error Tracking (Core)',
        description:
          'Python/Django SDK setup - Capture exceptions and logging events with structured context',
        feature: 'error-tracking',
      ...
      },
      {
        ...
        title: 'Dashboards & Alerts',
        description:
          'Custom dashboards for API performance and error rates - Automated alerts for spikes or anomalies',
        feature: 'dashboards-alerts',
        modules: ['custom-dashboards'],
        outcomes: [
  ...
  // Full-stack Developer Learning Path
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Dashboards & Alerts',
        description:
          'Unified dashboards to track full-stack performance - Advanced alert rules to detect regression patterns',
        feature: 'dashboards-alerts',
        modules: ['custom-dashboards'],
        outcomes: [
  ...
  // AI/ML-Aware Developer Learning Path
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Implement Seer for advanced debugging of AI workflows - Use MCP to trace and debug ML models in production',
        feature: 'seer-mcp',
        modules: ['custom-dashboards'],
        outcomes: [
      ...
      },
      {
        ...
        description:
          'Track domain-specific metrics like accuracy, model drift, or feature importance',
      ...
      },
      {
        ...
        title: 'Dashboards & Alerts',
        description:
          'Build model health dashboards - Create alerts for anomalies in inference or performance degradation',
        feature: 'dashboards-alerts',
        modules: ['custom-dashboards'],
        outcomes: [
  ...
  // Product Manager / Engineering Manager Learning Path
  {
    ...
    description:
      'Turn raw observability data into actionable insights for improving product quality, performance, and user experience',
    ...
    steps: [
      {
        ...
        description:
          'Learn to interpret error rates, performance metrics, and user experience data without technical complexity',
      ...
      },
      {
        ...
        description:
          'Create executive and stakeholder dashboards that communicate product health and quality trends',
        feature: 'dashboards-alerts',
        modules: ['custom-dashboards'],
        outcomes: [
      ...
      },
      {
        ...
        description:
          'Analyze how technical issues affect user behavior, retention, and product adoption',
        feature: 'performance-monitoring',
        modules: ['performance-monitoring'],
        outcomes: [
      ...
      },
      {
        ...
        description:
          'Create regular reports and alerts that keep teams aligned on product quality goals',
...
export const rolePersonalizations: RolePersonalization[] = [
  {
    ...
    contentAdaptations: {
      'sentry-fundamentals': {
        explanation:
          'Error tracking captures JavaScript exceptions, promise rejections, and React component errors that break the user experience.',
        whyRelevant:
          'Frontend errors directly impact users and can lead to lost conversions, frustrated users, and negative app store reviews.',
        nextStepNudge:
          "Next, we'll monitor your app's performance to ensure fast loading times and smooth user interactions.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring tracks Core Web Vitals like LCP, FID, and CLS that Google uses for search rankings and user experience.',
        whyRelevant:
          'Slow frontend performance hurts user engagement, SEO rankings, and conversion rates - especially on mobile devices.',
        nextStepNudge:
          "Let's add structured logging to capture user interactions and debugging context.",
      },
      'react-error-boundaries': {
        explanation:
          'Structured logging captures user interactions, component state, and debugging context to help you understand error patterns.',
        whyRelevant:
          'Frontend debugging requires understanding user context - logs help you trace user actions that lead to errors.',
        nextStepNudge:
          "Next, we'll add session replay so you can see exactly what users experienced when they encountered issues.",
      },
      'user-feedback': {
        explanation:
          'User feedback systems let users report issues directly, linking their reports to specific errors and sessions.',
        whyRelevant:
          'Real user feedback helps you prioritize fixes and understand the business impact of frontend issues.',
        nextStepNudge:
          "Let's set up dashboards and alerts to monitor your frontend KPIs and error trends.",
      },
    },
  },
  {
    ...
    contentAdaptations: {
      'nodejs-integration': {
        explanation:
          'Error tracking helps you catch API failures, database connection issues, and service exceptions before users complain.',
        whyRelevant:
          'As a backend engineer, you need visibility into server-side errors that can affect multiple users and downstream services.',
        nextStepNudge:
          "Next, we'll add performance monitoring to track API latency and database query performance.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring shows you API response times, database query performance, and service throughput metrics.',
        whyRelevant:
          'Your APIs are the backbone of the application - slow backend performance directly impacts user experience.',
        nextStepNudge:
          "Let's add structured logging to capture detailed context for debugging complex backend issues.",
      },
      'react-error-boundaries': {
        explanation:
          'Structured logging captures request context, database queries, and application state for better debugging.',
        whyRelevant:
          'Backend debugging requires detailed context - logs help you trace request flows and identify root causes.',
        nextStepNudge:
          "Next, we'll implement distributed tracing to follow requests across your microservices.",
      },
      'distributed-tracing': {
        explanation:
          'Distributed tracing tracks requests across microservices, helping you identify latency bottlenecks and service dependencies.',
        whyRelevant:
          'In microservice architectures, understanding request flows is critical for identifying performance and reliability issues.',
        nextStepNudge:
          "Let's set up release health monitoring to track deployment stability and catch regressions.",
      },
    },
  },
  {
    ...
    contentAdaptations: {
      'sentry-fundamentals': {
        explanation:
          'Error tracking connects frontend and backend errors, giving you end-to-end visibility into user journeys and system health.',
        whyRelevant:
          'As a full-stack engineer, you need to understand how frontend issues relate to backend problems and vice versa.',
        nextStepNudge:
          "Next, we'll add backend error tracking to complete your full-stack monitoring setup.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring shows you the complete user journey - from page load times to API response times to database queries.',
        whyRelevant:
          'Full-stack performance issues require understanding both client-side rendering and server-side processing bottlenecks.',
        nextStepNudge:
          "Let's add unified logging across both frontend and backend for comprehensive debugging.",
      },
      'react-error-boundaries': {
        explanation:
          'Unified logging captures context from both frontend and backend, helping you debug complex cross-layer issues.',
        whyRelevant:
          'Full-stack debugging requires correlating frontend user actions with backend processing and database queries.',
        nextStepNudge:
          "Next, we'll add session replay to see the user perspective of full-stack interactions.",
      },
      'distributed-tracing': {
        explanation:
          'Distributed tracing follows requests from frontend to backend, showing you the complete technology stack performance.',
        whyRelevant:
          'Understanding end-to-end request flows helps you optimize performance across your entire application stack.',
        nextStepNudge:
          "Let's set up unified dashboards to monitor your full-stack application health.",
      },
    },
  },
  {
    ...
    contentAdaptations: {
      'nodejs-integration': {
        explanation:
          'Error monitoring aggregates issues across your entire infrastructure, giving you visibility into service health and reliability.',
        whyRelevant:
          "As an SRE, you're responsible for system reliability - error tracking helps you identify and respond to incidents quickly.",
        nextStepNudge:
          "Next, we'll add distributed tracing to help you understand request flows and identify bottlenecks across microservices.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring shows you service latency, throughput, and dependency health across your distributed systems.',
        whyRelevant:
          'Performance issues can cascade through distributed systems - you need visibility to maintain your SLOs and prevent outages.',
        nextStepNudge:
          "Let's set up centralized logging for structured incident data capture and analysis.",
      },
      'react-error-boundaries': {
        explanation:
          'Centralized logging aggregates data from all services, providing structured context for incident response and post-mortems.',
        whyRelevant:
          'During incidents, you need quick access to correlated logs across all services to understand root causes and impact.',
        nextStepNudge:
          "Next, we'll build infrastructure-wide dashboards to monitor system health at scale.",
      },
      'custom-dashboards': {
        explanation:
          'Infrastructure dashboards centralize SLIs, service health metrics, and capacity utilization across your entire platform.',
        whyRelevant:
          'Unified dashboards help you correlate issues across services and provide critical context during incident response.',
        nextStepNudge:
          "Let's set up intelligent alerting that integrates with your on-call processes and escalation policies.",
      },
    },
  },
  {
    ...
    contentAdaptations: {
      'nodejs-integration': {
        explanation:
          'Error tracking captures failures in ML training pipelines, inference APIs, and model deployment workflows.',
        whyRelevant:
          'AI/ML systems have unique failure modes - model errors, data pipeline issues, and inference timeouts require specialized monitoring.',
        nextStepNudge:
          "Next, we'll monitor inference latency and throughput to optimize your model serving performance.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring tracks model inference latency, throughput, and resource utilization for ML workloads.',
        whyRelevant:
          'ML performance directly impacts user experience and infrastructure costs - you need visibility into model efficiency.',
        nextStepNudge:
          "Let's add structured logging to capture training metrics, data quality issues, and model confidence scores.",
      },
      'react-error-boundaries': {
        explanation:
          'Structured logging captures training metrics, data drift indicators, feature importance, and model prediction confidence.',
        whyRelevant:
          'ML debugging requires domain-specific context - logs help you track data quality and model behavior over time.',
        nextStepNudge:
          "Next, we'll implement Seer and MCP for AI-powered debugging of complex ML workflows.",
      },
      'custom-dashboards': {
        explanation:
          'Seer provides AI-powered debugging for ML workflows, while MCP enables model tracing and performance analysis.',
        whyRelevant:
          'Complex ML systems benefit from AI-assisted debugging - Seer and MCP help you understand model behavior automatically.',
        nextStepNudge:
          "Let's add distributed tracing to monitor your complete ML lifecycle from data ingestion to inference.",
      },
      'distributed-tracing': {
        explanation:
          'Distributed tracing follows data through your ML pipeline - from ETL to training to deployment to inference.',
        whyRelevant:
          'ML workflows span multiple systems and processes - tracing helps you identify bottlenecks in your data and model pipelines.',
        nextStepNudge:
          "Next, we'll set up custom metrics to track model accuracy, drift, and business-specific KPIs.",
      },
    },
  },
  {
    ...
    contentAdaptations: {
      'custom-dashboards': {
        explanation:
          'Dashboards translate complex technical metrics into clear, actionable insights for product decisions and stakeholder communication.',
        whyRelevant:
          'As a PM or Engineering Manager, you need to understand product health trends and communicate quality status to leadership and stakeholders.',
        nextStepNudge:
          "Next, we'll learn to build executive dashboards that clearly communicate product quality and performance trends.",
      },
      'performance-monitoring': {
        explanation:
          'Performance monitoring reveals how technical issues directly impact user experience, retention, and business metrics.',
        whyRelevant:
          'Understanding the connection between performance and user behavior helps you prioritize engineering work and make data-driven product decisions.',
        nextStepNudge:
          "Let's set up stakeholder reporting systems to keep your team aligned on product quality goals.",
      },
      'team-workflows': {
        explanation:
          'Automated reporting and alert systems ensure critical quality issues are surfaced to the right people at the right time.',
        whyRelevant:
          'Establishing systematic quality review processes helps maintain high product standards and prevents issues from impacting users.',
        nextStepNudge:
          "You're building a comprehensive data-driven approach to product quality management.",
      },
    },
  },
]
...
export function getEnhancedLearningPathForRole(role_id: EngineerRole): LearningPath | undefined {
  ...
  const aiCourses = getApprovedAIGeneratedCourses().filter(course =>
    course.generationRequest.targetRoles.includes(role_id)
  )
...
export function getAllEnhancedLearningPaths(): LearningPath[] {
  return roles
    .map(role => getEnhancedLearningPathForRole(role.id))
